...
" TODO  https://github.com/yegappan/lsp
...
let g:vimwiki_list = [{'path': '~/PhystechEdu/info/'}]
...
set number                           " Включение абсолютной нумерации строк
set relativenumber
set cursorline
set nowrap
...
imap <script><silent><nowait><expr> <leader>cm codeium#Accept()
nnoremap <leader>u :UndotreeToggle<CR>

nmap <leader>sl :setlocal spell! <Bar> :if &textwidth == 0 \| set textwidth=80 \| else \| set textwidth=0 \| endif<CR>
